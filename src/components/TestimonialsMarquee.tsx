    ...
    <section className="relative py-20 sm:py-28 bg-[#F7F4EB] text-[#0F0F0F] border-t border-[#0F0F0F]/10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          <div className="inline-flex items-center justify-center gap-1.5 sm:gap-2 rounded-full border border-[#0F0F0F]/10 bg-white px-2.5 min-[360px]:px-3.5 sm:px-4 py-1 sm:py-1.5 mb-4 shadow-sm">
            ...
            <span className="text-[9.5px] min-[360px]:text-[10.5px] sm:text-xs font-display font-bold uppercase tracking-tight min-[360px]:tracking-normal sm:tracking-wider text-[#0F0F0F] whitespace-nowrap">
