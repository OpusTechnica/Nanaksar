...
const PLATFORMS = [
  {
    ...
    btnClass: "bg-[#FC8019] hover:bg-[#E56F08] text-white shadow-[#FC8019]/20",
  ...
  },
  {
    ...
    btnClass: "bg-[#E23744] hover:bg-[#CC2532] text-white shadow-[#E23744]/20",
  ...
  },
  {
    ...
    btnClass: "bg-[#5B3CE6] hover:bg-[#4828D6] text-white shadow-[#5B3CE6]/20",
  ...
  },
  {
    ...
    btnClass: "bg-[#1A73E8] hover:bg-[#1557B0] text-white shadow-[#1A73E8]/20",
...
<section id="platforms" class="py-20 sm:py-28 bg-[#0A0A0A] text-white border-t border-white/10 relative overflow-hidden">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    <!-- Section Eyebrow & Headline Matching Reference -->
    <div class="text-center max-w-3xl mx-auto mb-14 sm:mb-18">
      <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#E5A93C]/40 bg-[#121212] mb-4 shadow-sm">
    ...
    <!-- 4 Platform Cards Grid (Pixel-Perfect Reference Match) -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
      {PLATFORMS.map((p) => (
        <div class={`bg-[#121212] rounded-3xl p-6 sm:p-7 border border-white/10 ${p.cardBorder} transition-all duration-300 flex flex-col justify-between text-center group shadow-2xl hover:translate-y-[-3px]`}>
          
          <div>
            <!-- Top Partner Tag -->
            <p class={`text-[10px] font-mono font-bold tracking-wider uppercase mb-6 italic ${p.tagColor}`}>
              {p.partnerTag}
            </p>
            ...
            <div class="mb-5 flex justify-center">
              {p.iconType === 'swiggy' && (
                <div class="w-16 h-16 rounded-full bg-[#FC8019] flex items-center justify-center shadow-xl ring-4 ring-[#FC8019]/20 group-hover:scale-105 transition-transform">
                  <!-- Swiggy Icon -->
                  <svg class="w-8 h-8 fill-white" viewBox="0 0 32 32">
                    <path d="M16 2C10.5 2 6 6.5 6 12c0 7.5 9 17.5 9.5 18 .3.3.7.3 1 0 .5-.5 9.5-10.5 9.5-18 0-5.5-4.5-10-10-10zm0 14.5c-2.5 0-4.5-2-4.5-4.5S13.5 7.5 16 7.5s4.5 2 4.5 4.5-2 4.5-4.5 4.5z"/>
                  </svg>
                </div>
              )}

              {p.iconType === 'zomato' && (
                <div class="w-16 h-16 rounded-full bg-[#E23744] flex items-center justify-center shadow-xl ring-4 ring-[#E23744]/20 group-hover:scale-105 transition-transform px-2">
                  <span class="font-sans font-black text-white text-sm tracking-tighter lowercase italic transform -rotate-1">
                    zomato
                  </span>
                </div>
              )}
              ...
              {p.iconType === 'magicpin' && (
                <div class="w-16 h-16 rounded-full bg-[#2A1B6D] border border-[#5B3CE6]/40 flex items-center justify-center shadow-xl ring-4 ring-[#5B3CE6]/20 group-hover:scale-105 transition-transform px-2">
              ...
              {p.iconType === 'google' && (
                <div class="w-16 h-16 rounded-full bg-white flex items-center justify-center shadow-xl ring-4 ring-white/20 group-hover:scale-105 transition-transform">
            ...
            <div class="bg-[#181818] rounded-2xl p-3 sm:p-3.5 my-6 border border-white/5 text-center">
          ...
          <a
            ...
            class={`w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl font-display text-xs sm:text-sm font-bold uppercase tracking-wider transition ${p.btnClass} min-h-[46px] shadow-lg`}
          >
            <span>{p.btnText}</span>
...
print("Updated PlatformsSection.astro with exact mockup match")
